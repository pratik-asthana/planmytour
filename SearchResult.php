        ...
        <div class="block_info">
            <div class="info_block">
                ...
                <div class="package_flight_bx">
                    ...
                    <div>
                        <p class="quote_ref"><i class="fa fa-comment" aria-hidden="true"></i> <b>Quote Ref:{quoteReference}</b></p>
            ...
            <div class="package_book_bx">
                <div class="amount-bx">
                    ...
                    <div>per person <span style="color:#1fb6fd;"></span></div>
                </div>

                <div class="contact-bx-dv">
                    <div><b>call on </b> </div>
                    <div class="phone"><i class="fa fa-phone-square" aria-hidden="true"></i>0207 183 6982</div>
		<div><button class="custom-btn" onclick="window.open(\'detail/package.php?quoteReference={quoteReference}\',\'popUpWindow\',\'height=450,width=710,left=300,top=120,resizable=0,scrollbars=0,toolbar=0,menubar=0,location=0,directories=0, status=yes\');"><i class="fa fa-info-circle" aria-hidden="true"></i> Hotel Details</button></div>
                </div>
                <button class="custom-btn" onclick="javascript:fillPackagePopup(\'{quoteReference}\')" data-toggle="modal" data-target="#flightBookModal">BOOK NOW</button><br>
            </div>
        </div>
    </div>
</div>
